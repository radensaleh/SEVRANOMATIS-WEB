...
class Nilai(models.Model):
    ...
    skor = models.PositiveIntegerField(validators=[MaxValueValidator(4)])
    created_at = models.CharField(max_length=20)
    updated_at = models.CharField(max_length=20)

class LogNilai(models.Model):
    kd_log = models.CharField(max_length=10, primary_key=True)
    kd_nilai = models.ForeignKey(Nilai, on_delete=models.PROTECT)
    no = models.PositiveIntegerField(validators=[MaxValueValidator(3)])
    pertanyaan = models.TextField()
    jawaban=models.TextField()
    skor1 = models.PositiveIntegerField(validators=[MaxValueValidator(3)])
    skor2 = models.PositiveIntegerField(validators=[MaxValueValidator(3)])
    skor3 = models.PositiveIntegerField(validators=[MaxValueValidator(3)])
    skor_tertinggi = models.PositiveIntegerField(validators=[MaxValueValidator(3)])
    skor_ratarata = models.PositiveIntegerField(validators=[MaxValueValidator(3)])
    skor_akhir = models.PositiveIntegerField(validators=[MaxValueValidator(3)])
    status = models.PositiveIntegerField(validators=[MaxValueValidator(3)])
    created_at = models.CharField(max_length=20)
    updated_at = models.CharField(max_length=20)
